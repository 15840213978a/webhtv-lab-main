...
public class HomeActivity extends BaseActivity implements NavigationBarView.OnItemSelectedListener, WebHomeChromeController.Host {
    ...
    protected void onResume() {
        super.onResume();
        if (mBinding.navigation.getMenu().findItem(R.id.lab).isVisible() != LabConfig.get().isBottomButtonVisible()) setNavigation();
    }
    ...
    private void setNavigation() {
        ...
        mBinding.navigation.getMenu().findItem(R.id.lab).setVisible(LabConfig.get().isBottomButtonVisible());

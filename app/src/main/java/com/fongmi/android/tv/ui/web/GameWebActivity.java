...
public class GameWebActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // loading 占位层是 WebReaderActivity(reader.html 模板) 共用的首屏占位，游戏页直接 loadUrl 远程地址，
        // 不需要它；若不隐藏会一直显示浅色底 + 无限转圈（白屏转圈）。
        ...
        if (loadUrl.isEmpty()) {
            Toast.makeText(this, "游戏地址为空", Toast.LENGTH_SHORT).show();
            finish();
            return;
        }
